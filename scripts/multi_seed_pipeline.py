...
Step 1: Gate all 9 checkpoints (3 seeds × 3 iterations)
...
# 9 checkpoints: 3 seeds × 3 stages
CHECKPOINTS = [
...
# ============================================================
log("=" * 60)
log("STEP 1: Gate Sweep — 9 checkpoints")
log("=" * 60)
...
# ============================================================
log("\n" + "=" * 60)
log(f"STEP 2: Round-Robin Tournament — {len(passed_agents)} agents")
log("=" * 60)
